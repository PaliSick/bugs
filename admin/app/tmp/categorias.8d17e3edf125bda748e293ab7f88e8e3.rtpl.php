                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="nuevo" style="display: none" class="col-lg-12">
                            <div class="col-lg-5">
                                <form action="http://bugsalimentos.com/admin/parametros/submit_categoria" name="cat-nuevo" id="cat-nuevo" method="get">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-categoria">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="http://bugsalimentos.com/admin/parametros/getCategoria/<?php echo $value1["Id"];?>" class="glyphicon glyphicon-pencil edit"></a>
                                                    <td><a href="http://bugsalimentos.com/admin/parametros/deleteCategoria/<?php echo $value1["Id"];?>" class="glyphicon glyphicon-trash delete"></a>
                                                </tr>
                                                <?php }else{ ?>
        ...
        $(document).ready(function() {
            ...
            $('#cat-nuevo').submit(function(e) {
                ...
                $.post($this.attr('action'), params, function(data){
                    ...
                    if (data.status == 'ok') {
                        window.location = "<?php echo $base_path;?>/parametros/categorias/alert/success/"+data.info;
