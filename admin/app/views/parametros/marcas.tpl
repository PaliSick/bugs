                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div id="nuevo" style="display: none" class="col-lg-12">
                            <div class="col-lg-5">
                                <form action="parametros/submit_marca" name="cat-nuevo" id="cat-nuevo" method="get">
                                    ...
                                    <div class="dataTable_wrapper">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-categoria">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{$value.Marca}</td>
                                                    <td><a href="parametros/getMarca/{$value.Id}" class="glyphicon glyphicon-pencil edit"></a>
                                                    <td><a href="parametros/deleteMarca/{$value.Id}" class="glyphicon glyphicon-trash delete"></a>
                                                </tr>
                                                {else}
                                                <tr>
        ...
        $(document).ready(function() {
            ...
            $('#cat-nuevo').submit(function(e) {
                ...
                $.post($this.attr('action'), params, function(data){
                    ...
                    if (data.status == 'ok') {
                        window.location = "{$base_path}/parametros/marcas/alert/success/"+data.info;
